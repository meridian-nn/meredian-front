  ...
  <div class="outgoing-payment-documents-main-div">
    ...
    >
      ...
      <div class="outgoing-payment-documents-row mt-3">
        ...
        <p class="mr-3 pt-2">Соисполнитель:</p>
      ...
      <div class="outgoing-payment-documents-row mt-5">
        <p class="mr-3 pt-2">Назначение:</p>
        <v-text-field
          class="pt-0"
          readonly
          v-model="appointment"
...
<style lang="scss">
  ...
  #outgoing-payment-documents-table  tr:nth-child(even){background-color: #f2f2f2;}

  #outgoing-payment-documents-table  tr:hover {background-color: #ddd;}
