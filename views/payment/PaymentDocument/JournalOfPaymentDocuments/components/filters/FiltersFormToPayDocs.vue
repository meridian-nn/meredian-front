<template>
  <v-dialog
    ...
    max-width="1200px"
    padding="0px"
    class="filters-for-to-pay-docs-modal"
    @input="$emit('close')"
  >
    <v-card class="modal-card">
      <v-card-title>
        <span class="headline">Фильтры для таблицы "Документы к оплате"</span>
      </v-card-title>
...
export default {
  name: 'FiltersFormToPayDocs',
  data() {
    return {
      // id элемента, для которого будут сохранены настроики фильтров
      elementId: 'journal-of-payment-docs-to-pay-docs',
