      ...
      default(text) {
        ...
        switch (this.type) {
          ...
          case 'map':
            ...
            } else { return Object.keys(this.options).find(k => this.options[k] === text) }
          default:
            return text
        }
      }
    ...
    toText: {
      ...
      default(val) {
        ...
        switch (this.type) {
          ...
          case 'map':
            if (this.options.constructor.name.endsWith('Function')) { return this.options(val)[val] } else { return this.options[val] }
          default:
            return val
        }
      }
    ...
    init() {
      ...
      switch (this.type) {
        ...
        case 'checkTF':
          ...
          break
        case 'map':
          if (this.options.constructor.name === 'AsyncFunction') { throw new Error('VueExcelColumn: Map does not support Async Function') }
          break
        case 'select':
          break
        case 'string':
